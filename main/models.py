...
class weatherModel(models.Model):
    ...
    out_hum  = models.IntegerField(blank=True,null=True)                    #integer field
    ...
    in_hum = models.IntegerField(blank=True,null=True)                      #integer field
    ...
    wind_samp = models.IntegerField(blank=True,null=True)                   #integer field
    wind_tx = models.IntegerField(blank=True,null=True)                     #integer field
    iss_recept = models.FloatField(blank=True,null=True)                    #float field
    arc_int = models.IntegerField(blank=True,null=True)                     #integer field
